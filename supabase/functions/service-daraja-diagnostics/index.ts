...
serve(async (req) => {
  ...
  try {
    ...
    const payload = {
      ...
      AccountReference: "FAHARI",
      TransactionDesc: "Fahari subscription diagnostic",
    };
    ...
    return json({ ok: true, message: "STK accepted. Fahari service Daraja setup works.", report });
  } catch (error) {
